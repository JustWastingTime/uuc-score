    ...
    { "name": "GROUP B",
      "clubs": {
        "UMAlliance": {
          ...
          "Long": [["Jaya", "NICE NATURE", "LS"], ["horshi", "BIWA HAYAHIDE", "PC"], ["Fafa", "TAMAMO CROSS", "LS"]]
        },
        "Tracen Academy": {
          "Sprint": [["Duck", "CURREN CHAN", "PC"], ["Falconhit", "SMART FALCON", "FR"], ["Myuri", "SILENCE SUZUKA", "FR"]],
          "Mile": [["Fwoxie", "MIHONO BOURBON", "FR"], ["Mint", "FINE MOTION", "PC"], ["Haru", "OGURI CAP", "EC"]],
    ...
    { "name": "GROUP C",
      "clubs": {
        "Uma Love": {
          ...
          "Mile": [["Mayano's Dad", "MAYANO TOP GUN", "PC"], ["KuraS", "NISHINO FLOWER", "PC"], ["HoboPhoenix", "TAIKI SHUTTLE", "PC"]],
          "Medium": [["Penou", "KITASAN BLACK", "FR"], ["Chris4th", "NARITA TAISHIN", "EC"], ["Mauro", "OGURI CAP", "EC"]],
          "Long": [["Oki", "TAMAMO CROSS", "EC"], ["Xnaw", "KAWAKAMI PRINCESS", "LS"], ["Powd", "GOLD SHIP", "EC"]]
        },
        "FALENA": {
          "Sprint": [["Womble", "SMART FALCON", "FR"], ["Ink@VF", "HISHI AKEBONO", "PC"], ["Clowngeta", "CURREN CHAN", "PC"]],
          "Mile": [["Haiji", "TAIKI SHUTTLE", "PC"], ["TheOddNati", "NISHINO FLOWER", "PC"], ["UProb", "NARITA TAISHIN", "EC"]],
          "Medium": [["Zera", "MIHONO BOURBON", "FR"], ["XV11", "KITASAN BLACK", "FR"], ["TOTdemolisher", "INARI ONE", "EC"]],
          "Long": [["lazarus", "GOLD SHIP", "EC"], ["omatsuri mambo!", "MATIKANETANNHAUSER", "LS"], ["Korie", "SATONO DIAMOND", "LS"]]
        },
        "BUNS": {
          "Sprint": [["JLew＠BUNS", "SAKURA BAKUSHIN O", "PC"], ["Buttered＠BUNS", "CURREN CHAN", "PC"], ["Banana＠BUNS", "KING HALO", "EC"]],
          "Mile": [["Hi！Im Aru！＠BUNS", "NARITA TAISHIN", "EC"], ["Kai Aiya＠BUNS", "OGURI CAP", "EC"], ["Bane", "HISHI AMAZON", "EC"]],
    ...
    },
    {
      ...
      "clubs": {
        "Uma Sports / Temu Gooners": {
          ...
          "Mile": [["UUC | Koco", "NICE NATURE", "LS"], ["Hurricane", "NARITA TAISHIN", "EC"], ["Makishi", "SMART FALCON", "FR"]],
        ...
        "Avalon Racing": {
          ...
          "Long": [["Ammar", "TM OPERA O", "LS"], ["Hatterem", "SATONO DIAMOND", "LS"], ["Annie", "MAYANO TOP GUN", "EC"]]
        },
        "Revolt / Usurp": {
          "Sprint": [["Karasu", "NISHINO FLOWER", "PC"], ["Ophir", "CURREN CHAN", "PC"], ["Usurper", "EL CONDOR PASA", "PC"]],
          "Mile": [["Rat@TTA", "GOLD CITY", "LS"], ["Euth", "MARUZENSKY", "FR"], ["Scar@Velocity", "SEIUN SKY", "FR"]],
          "Medium": [["Wunke", "NARITA TAISHIN", "EC"], ["Miya", "MIHONO BOURBON", "FR"], ["Nie@Dirtbobo", "KITASAN BLACK", "FR"]],
          "Long": [["Morn", "TAMAMO CROSS", "EC"], ["OJ", "GOLD SHIP", "EC"], ["Shnail", "OGURI CAP", "PC"]]
        },
        "Bakushin": {
          "Sprint": [["Lasercar", "SAKURA BAKUSHIN O", "PC"], ["Luminous", "KING HALO", "EC"], ["StyIX", "NISHINO FLOWER", "PC"]],
          "Mile": [["Sora", "MIHONO BOURBON", "FR"], ["TwilightOnyx＿YT", "MARUZENSKY", "FR"], ["NBY", "TAMAMO CROSS", "LS"]],
      ...
      "results": {
        ...
        "Uma Sports / Temu Gooners__vs__Bakushin": { "Sprint": "UUC | NasiBrianni", "Mile": "TwilightOnyx＿YT", "Medium": "", "Long": "" },
